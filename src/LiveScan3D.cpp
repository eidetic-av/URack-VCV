...
struct LiveScan3D : URack::UModule {
	...
	LiveScan3D() {
		...
		configUpdate(MIN_BOUNDS_Y_PARAM, MIN_BOUNDS_Y_INPUT,
				MIN_BOUNDS_Y_INPUT_SCALE_PARAM, "MinY");
		configUpdate(MIN_BOUNDS_Z_PARAM, MIN_BOUNDS_Z_INPUT,
				MIN_BOUNDS_Z_INPUT_SCALE_PARAM, "MinZ");
		configUpdate(MAX_BOUNDS_X_PARAM, MAX_BOUNDS_X_INPUT,
				MAX_BOUNDS_X_INPUT_SCALE_PARAM, "MaxX");
		configUpdate(MAX_BOUNDS_Y_PARAM, MAX_BOUNDS_Y_INPUT,
				MAX_BOUNDS_Y_INPUT_SCALE_PARAM, "MaxY");
		configUpdate(MAX_BOUNDS_Z_PARAM, MAX_BOUNDS_Z_INPUT,
				MAX_BOUNDS_Z_INPUT_SCALE_PARAM, "MaxZ");
		configUpdate(SCALE_X_PARAM, SCALE_X_INPUT, SCALE_X_INPUT_SCALE_PARAM,
				"ScaleX");
		configUpdate(SCALE_Y_PARAM, SCALE_Y_INPUT, SCALE_Y_INPUT_SCALE_PARAM,
				"ScaleY");
		configUpdate(SCALE_Z_PARAM, SCALE_Z_INPUT, SCALE_Z_INPUT_SCALE_PARAM,
				"ScaleZ");
	}
};
