...
struct Billboard : URack::UModule {
	...
	Billboard() {
		...
		configBiUpdate("TurbulenceScale", TURBULENCE_SCALE_PARAM, TURBULENCE_SCALE_INPUT);
...
struct BillboardWidget : URack::UModuleWidget {
	BillboardWidget(Billboard* module) {
		...
		addPointCloudOutput(mm2px(Vec(88.702, 108.759)), module, Billboard::POINT_CLOUD_INPUT, "PointCloudOutput");
	}
};
