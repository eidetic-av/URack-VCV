...
struct RendererWidget : URack::UModuleWidget {
	RendererWidget(Renderer* module) {
		...
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(35.646, 10.958)), module, Renderer::SPAWN_RATE_PARAM));
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(13.312, 23.383)), module, Renderer::POINT_COUNT_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(52.782, 27.539)),
					module,
					Renderer::LIFETIME_ATTEN_PARAM));
		addParam(
				createParamCentered<Trimpot>(mm2px(Vec(30.773, 27.814)), module,
					Renderer::SPAWN_RATE_ATTEN_PARAM));
		addParam(
		...
		addParam(createParamCentered<Trimpot>(
					mm2px(Vec(30.224, 57.705)), module, Renderer::FUZZ_ATTEN_PARAM));
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(16.215, 58.03)), module, Renderer::TURBULENCE_PARAM));
		addParam(createParamCentered<Trimpot>(
					mm2px(Vec(52.998, 58.234)), module, Renderer::SIZE_ATTEN_PARAM));
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(60.689, 73.715)), module, Renderer::FORCE_X_PARAM));
		addParam(
		...
		addParam(createParamCentered<Trimpot>(
					mm2px(Vec(10.876, 103.377)), module, Renderer::DELAY_ATTEN_PARAM));
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(38.915, 103.536)), module, Renderer::FORCE_Y_PARAM));
		addParam(createParamCentered<Davies1900hWhiteKnob>(
					mm2px(Vec(60.272, 103.817)), module, Renderer::FORCE_Z_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(34.042, 120.392)),
					module,
					Renderer::FORCE_Y_ATTEN_PARAM));
		addParam(createParamCentered<Trimpot>(
					mm2px(Vec(10.595, 120.438)), module, Renderer::SCROLL_ATTEN_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(55.399, 120.673)),
					module,
					Renderer::FORCE_Z_ATTEN_PARAM));

		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(61.501, 27.539)), module, Renderer::LIFETIME_INPUT));
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(39.491, 27.814)), module, Renderer::SPAWN_RATE_INPUT));
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(17.157, 40.239)), module, Renderer::POINT_COUNT_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(38.943, 57.705)),
					module, Renderer::FUZZ_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(61.717, 58.234)),
		...
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(19.595, 103.377)), module, Renderer::DELAY_INPUT));
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(42.76, 120.392)), module, Renderer::FORCE_Y_INPUT));
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(19.314, 120.438)), module, Renderer::SCROLL_INPUT));
		addInput(createInputCentered<PJ301MPort>(
					mm2px(Vec(64.117, 120.673)), module, Renderer::FORCE_Z_INPUT));

		addPointCloudInput(mm2px(Vec(7.567, 8.31)), module,
				Renderer::POINT_CLOUD_INPUT, "PointCloud");
	}
};
