...
struct Dispatcher {
  ...
  void send(std::vector<int> hosts, std::string address,
  ...
  void query(std::vector<int> hosts, std::string address,
             std::function<void(void *, std::vector<std::string>)> functor,
             void *instance) {
    for (int host : hosts)
  ...
  void query(int hostNum, std::string address,
             std::function<void(void *, std::vector<std::string>)> functor,
             void *instance) {
    std::lock_guard<std::mutex> guard(updateMutex);
    auto update = new OscUpdate;
  ...
  void action(std::vector<int> hosts, std::string address,
              std::string argument) {
    for (int host : hosts)
